...
public class AuthService {
    ...
    @Autowired
    LoadBalancerClient loadBalancerClient;     //获取示例对象

    @Autowired
    StringRedisTemplate stringRedisTemplate;    //redis对象

    @Autowired
    RestTemplate restTemplate;      //远程调用对象
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret){
        ...
        ServiceInstance serviceInstance = loadBalancerClient.choose(ScdaServiceList.SCDA_SERVICE_UCENTER_AUTH);
        //此地址就是http://ip:port
        URI uri = serviceInstance.getUri();
        System.out.println("uri(服务的地址) = " + uri);
    ...
    public boolean delToken(String access_token){
        String key = "user_token:" + access_token;  //身份令牌
