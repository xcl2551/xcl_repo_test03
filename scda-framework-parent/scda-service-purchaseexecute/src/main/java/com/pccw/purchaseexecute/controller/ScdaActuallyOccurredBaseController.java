 ...
 */
@RestController
@RequestMapping("/scdaActuallyOccurredBase")
public class ScdaActuallyOccurredBaseController implements ScdaActuallyOccurredBaseControllerApi{
    ...
    public QueryResponseResult<ScdaActuallyOccurredBase> findPage(@RequestBody PurchaseExecuteRequest purchaseExecuteRequest) {
        return scdaActuallyOccurredBaseService.findPage(purchaseExecuteRequest) ;
    }
    ...
    public void downloadExcel(@RequestBody PurchaseExecuteRequest purchaseExecuteRequest, HttpServletResponse response, HttpServletRequest request) throws IOException {
        //获取excel封装好数据的对象
        HSSFWorkbook hssfWorkbook = scdaActuallyOccurredBaseService.downloadExcel(purchaseExecuteRequest);
        //设置头信息
        response.setContentType("application/vnd.ms-excel");
        String filename = "ActuallyOccurredBase.xls";
